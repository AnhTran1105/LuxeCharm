...
function ProductUpdating() {
  ...
  return (
	...
	s1,0.4,1,1S12.6,17,12,17z M13,12c0,0.6-0.4,1-1,1s-1-0.4-1-1V8c0-0.6,0.4-1,1-1s1,0.4,1,1V12z"
              ...
              <div className="my-5 grid grid-cols-3 gap-3 justify-center items-center">
                {product.imageUrls.map((image) => (
                  <div key={image} className="relative">
                    <img src={image} className="" alt="product-image" />
                    <button
                      onClick={() => {
                        const updatedArr = additionalImages.filter(
                          (additionalImg) => additionalImg !== image
                        );
