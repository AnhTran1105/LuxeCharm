    ...
    <div className="group cursor-pointer relative">
      <div className="relative overflow-hidden">
        ...
        <img
          ...
          width="2251"
          height="3000"
          className="aspect-[4/5] opacity-0 hover:scale-[1.05] hover:opacity-100 transition-all duration-[400ms] ease-linear"
        ></img>
      </div>
      {isOff && (
      ...
      <button className="p-3 w-full border border-solid hover:outline-2 hover:outline transition-[outline] duration-100">
